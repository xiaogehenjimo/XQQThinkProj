...
@interface XQQEssenceOneViewController ()<UITableViewDelegate,UITableViewDataSource,ZFPlayerDelegate>
/**tableViewDataSource*/
...
@implementation XQQEssenceOneViewController
